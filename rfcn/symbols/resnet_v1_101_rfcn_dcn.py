...
class resnet_v1_101_rfcn_dcn(Symbol):
    ...
    def get_resnet_v1_conv4(self, data):
        ...
        return conv1_relu, res2c_relu, res3b3_relu,res4b22_relu
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        conv1_relu, res2c_relu, res3b3_relu,conv_feat = self.get_resnet_v1_conv4(data)
        # res5
        ...
        conv_feat = mx.symbol.Convolution(data=conv_feat, kernel=(3,3), pad=(1,1),
        ...
        relu1_res5 = mx.symbol.Convolution(data=relu1, kernel=(3,3), pad=(1,1),
                                        stride=(1, 1), num_filter=256, name="res5b10_relu_256conv", no_bias=True)
        relu1_res5_relu = mx.symbol.Activation(data=relu1_res5, act_type='relu', name='res5b10_relu_256conv_relu')
        res5_pooled = mx.symbol.ROIPooling(name='roi_pool_res5c', data=relu1_res5_relu, rois=rois, pooled_size=(7,7), spatial_scale=1.0/16.0)
        deformable_roi_pool_new = mx.symbol.add_n(conv1_relu_pooled, res2c_relu_pooled, res3b3_relu_pooled, conv_feat_pooled,res5_pooled, name='features_add')
        
        
        
             
        # conv_new_1
        conv_new_1 = mx.sym.Convolution(data=deformable_roi_pool_new, kernel=(1, 1), num_filter=1024, name="conv_new_1", lr_mult=3.0)
    ...
    def init_weight_rfcn(self, cfg, arg_params, aux_params):
        ...
        arg_params['conv1_relu_256conv_weight'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['conv1_relu_256conv_weight'])
        arg_params['res2c_relu_256conv_weight'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['res2c_relu_256conv_weight'])
        arg_params['res3b3_relu_256conv_weight'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['res3b3_relu_256conv_weight'])       

        arg_params['conv_feat_256conv_weight'] =mx.random.normal(0, 0.01, shape=self.arg_shape_dict['conv_feat_256conv_weight'])
        arg_params['res5b10_relu_256conv_weight'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['res5b10_relu_256conv_weight'])
